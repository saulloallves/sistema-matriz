...
interface FranqueadoAddModalProps {
  open: boolean;
  onClose: () => void;
  onUpdate: () => void;
}
...
export function FranqueadoAddModal({ open, onClose, onUpdate }: FranqueadoAddModalProps) {
  ...
  const onSubmit = async (data: FranqueadoFormData) => {
    ...
    try {
      ...
      toast.error("Erro ao criar franqueado");
    } finally {
      setLoading(false);
    }
  };
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <DialogActions sx={{ p: 3, borderTop: 1, borderColor: 'divider' }}>
          ...
          <Button
            ...
            disabled={loading}
          >
            {loading ? 'Salvando...' : 'Criar Franqueado'}
          </Button>
        </DialogActions>
      </form>
    </Dialog>
