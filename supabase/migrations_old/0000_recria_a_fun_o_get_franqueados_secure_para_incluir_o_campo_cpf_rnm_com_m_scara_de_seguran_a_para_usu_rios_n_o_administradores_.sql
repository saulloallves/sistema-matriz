-- Primeiro, removemos a função antiga para poder alterar sua estrutura de retorno
DROP FUNCTION IF EXISTS public.get_franqueados_secure();

-- Agora, criamos a nova versão da função com a coluna cpf_rnm
